...
// Install event - cache static assets and important images
    ...
    Promise.all([
      ...
      caches.open(IMAGE_CACHE).then((cache) => {
        ...
        const productImages = [
          ...
          'https://i.postimg.cc/tgmmKZmJ/netlistore.png'
        ];
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    ...
    icon: 'https://i.postimg.cc/tgmmKZmJ/netlistore.png',
    badge: 'https://i.postimg.cc/tgmmKZmJ/netlistore.png',
    data: data
  };
