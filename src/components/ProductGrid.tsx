      ...
      {products.map((product) => (
        ...
        >
          ...
          <div className="space-y-2">
            <h4 className="font-light text-sm leading-tight line-clamp-2 group-hover:text-gray-600 transition-colors min-h-[2.5rem] flex items-start">
              {product.name}
            </h4>
            ...
            <div className="mt-2">
              <Button
                size="sm"
                disabled={!product.inStock}
                className="w-full h-8 text-xs bg-black text-white hover:bg-gray-800 font-medium"
